...
namespace XTC.FMP.MOD.Analytics.LIB.MVCS
{
    ...
    public class GeneratorRecordRequestDTO : IDTO
    {
        public GeneratorRecordRequestDTO(GeneratorRecordRequest _value)
        {
            Value = _value;    
        }
        public readonly GeneratorRecordRequest Value;
    }



    public class GeneratorRecordResponseDTO : IDTO
    {
        public GeneratorRecordResponseDTO(GeneratorRecordResponse _value)
        {
            Value = _value;    
        }
        public readonly GeneratorRecordResponse Value;
    }
    ...
    public class TrackerRecordRequestDTO : IDTO
    {
        public TrackerRecordRequestDTO(TrackerRecordRequest _value)
        {
            Value = _value;    
        }
        public readonly TrackerRecordRequest Value;
    }
