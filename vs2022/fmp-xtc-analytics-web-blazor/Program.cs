...
using XTC.FMP.MOD.Analytics.App.Web;
...
public partial class Program
{
    public static async Task Main(string[] args)
    {
        ...
        permissioS[Permissions.GeneratorCreate] = "";
        permissioS[Permissions.GeneratorUpdate] = "";
        permissioS[Permissions.GeneratorRetrieve] = "";
        permissioS[Permissions.GeneratorDelete] = "";
        ...
        permissioS[Permissions.TrackerCreate] = "";
        permissioS[Permissions.TrackerUpdate] = "";
        permissioS[Permissions.TrackerRetrieve] = "";
        permissioS[Permissions.TrackerDelete] = "";
        ...
        framework.setUserData("XTC.FMP.MOD.Analytics.LIB.MVCS.Entry", entry);
